...
#include "iostream"				//  - desenarea de primitive grafice precum dreptunghiuri, cercuri sau linii, 
...
#include "SOIL.h"			
using namespace std;//	Biblioteca pentru texturare;
...
void LoadTexture(const char* texturePath, int texture_no)
{
	...
	// Load image and transfer data to OpenGL
	int width, height;
...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] = {
		//	Coordonate;					Culori;				Coordonate de texturare;
		  -500.0f, -350.0f, 0.0f, 1.0f,	  0.5f, 0.5f, 0.5f,	0.0f, 0.0f,	// Stanga jos;
		   500.0f, -350.0f, 0.0f, 1.0f,   0.5f, 0.5f, 0.5f,	1.0f, 0.0f, // Dreapta jos;
		   500.0f,  350.0f, 0.0f, 1.0f,   0.5f, 0.5f, 0.5f,	1.0f, 1.0f,	// Dreapta sus;
		  -500.0f,  350.0f, 0.0f, 1.0f,   0.5f, 0.5f, 0.5f,	0.0f, 1.0f  // Stanga sus;

		  - 600.0f, -450.0f, 0.0f, 1.0f,	  0.5f, 0.5f, 0.5f,	0.0f, 0.0f,	// Stanga jos;
		   600.0f, -450.0f, 0.0f, 1.0f,   0.5f, 0.5f, 0.5f,	1.0f, 0.0f, // Dreapta jos;
		   600.0f,  450.0f, 0.0f, 1.0f,   0.5f, 0.5f, 0.5f,	1.0f, 1.0f,	// Dreapta sus;
		  -600.0f,  450.0f, 0.0f, 1.0f,   0.5f, 0.5f, 0.5f,	0.0f, 1.0f  // Stanga sus;
	};

	//	Indicii care determina ordinea de parcurgere a varfurilor;
	GLuint Indices[] = {
	  0,2,1,  //	Primul triunghi;
	  0,3,2,	//  Al doilea triunghi;
...
void Initialize(void)
{
	...
	//	Incarcarea texturii;
	LoadTexture("C:/Users/alexc/OneDrive/Desktop/Grafica/Texturi/masa_verde2.png", 2);
	LoadTexture("C:/Users/alexc/OneDrive/Desktop/Grafica/Texturi/lemn.png", 2);
